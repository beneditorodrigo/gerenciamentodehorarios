...
private Hora hora;
	...
	public boolean verificaDisponibilidadeDeHorario(String horarioEntrada, String horarioSaida,
			ArrayList<Hora> marcacoesFeitas) {
		...
		if(contador >= marcacoesFeitas.size()) {
	...
	public void adcionandoMarcacoes(String horaEntrada, String horaSaida, Horarios horarios) {
		try {
			hora = new Hora(horaEntrada, horaSaida);
			horarios.getMarcacoesFeitas().add(hora);
			
			JOptionPane.showMessageDialog(null, "Marcação Cadastrada");
		} catch (Exception e) {
